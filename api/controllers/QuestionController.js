	...
	upload:function(req,res){
		...
		Team.findOne({id:flag.id},function(err,user){
			...
			Question.findOne({number:req.param('que'),round:req.param('round')},function(err,q){
				...
				req.file('file').upload({adapter:require('skipper-gridfs'),uri:'mongodb://Deathadder:***@ds123534.mlab.com:23534/reverse_coding_acm.fs',filename:'deathadder'},function(err,files){
